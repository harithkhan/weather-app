...
export async function displayFromHour() {
    ...
    if (currentHour >= 0 && currentHour < 3) { carousel.style.right = "0rem" };
    if (currentHour > 2 && currentHour < 6) { carousel.style.right = "20rem" };
    if (currentHour > 5 && currentHour < 9) { carousel.style.right = "40rem" };
